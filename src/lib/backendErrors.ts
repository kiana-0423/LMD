...
const TRANSLATED_CODES: Record<string, MessageKey> = {
  ...
  "design.requestInvalid": "error.designRequestInvalid",
  "design.generationFailed": "error.designGenerationFailed",
  "design.candidateNotFound": "error.designCandidateNotFound",
  "design.promotionRefused": "error.designPromotionRefused",
